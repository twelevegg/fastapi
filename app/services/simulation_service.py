    ...
    async def run_simulation(self):
        ...
        try:
            async with websockets.connect(uri) as websocket:
                ...
                # 2. Simulate Conversation Turns (KT Scenario)
                turns = [
                    {"turn_id": 1, "speaker": "agent", "transcript": "반갑습니다. KT 고객센터 상담사 이종환입니다. 무엇을 도와드릴까요?"},
                    ...
                    {"turn_id": 18, "speaker": "agent", "transcript": "네 고객님, 오늘도 좋은 하루 되세요. 상담사 이종환이었습니다."}
                ]
